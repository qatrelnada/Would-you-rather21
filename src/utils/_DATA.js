import sarahEdoAvatar from '../avatars/S.png'
import tylerMcGinnisAvatar from '../avatars/T.png'
import johnDoeAvatar from '../avatars/J.png'
...
function formatUser (firstName, lastName, img) {
  return {
...
export function _addUser (firstName, lastName, img) {
  return new Promise((res, rej) => {
    const formattedUser = formatUser(firstName, lastName, img);
...
export function _authedUser (id) {
  return new Promise((res, rej) => {
